<template>
  <div>
    <section
      class="pt-28 pb-20 bg-top bg-no-repeat bg-contain bg-[#15151A]"
...
const { data: coop } = await useAsyncData<any>('coop', () => $fetch('https://api.rechip-tuning.ru/api/page?slug=cooperation'))
definePageMeta({
  layout: 'custom'
})
</script>
